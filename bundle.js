...
/***/ function(module, exports, __webpack_require__) {
	...
	var Resume = __webpack_require__(162);
	...
	var App = React.createClass({
		...
		loadData: function loadData() {
			...
			this.setState({ currentResume: assigned, person: _resumeData.personalDetails });
		...
		render: function render() {
			return React.createElement(
				"div",
				null,
				React.createElement(Resume, { currentResume: this.state.currentResume, person: this.state.person })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.resumeEn = exports.personalDetails = exports.ResumeData = undefined;
	...
	var ResumeData = exports.ResumeData = function ResumeData(title, personalDetails) {
	...
	var resumeEn = exports.resumeEn = new ResumeData("Resume", personalDetails);
